    ...
    <ul class="top_navigation_bar">
      ...
      <li class="top_navigation_bar_li">
        <div
          ...
          :style="store.islogin?{'background-image':'url(./src/assets/image/22.jpg)',
          'z-index':100}:
          {'background-color': store.top_navigation_bar_login_background_color}
          "
        >
          <router-link
            class="router_link_login"
            to="/login"
            :style="store.islogin?{opacity: 0}:{'color': store.top_navigation_bar_li_color}"
            >登录</router-link
          >
        </div>
      </li>
