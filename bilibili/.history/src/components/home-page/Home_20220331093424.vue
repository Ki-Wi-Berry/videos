<template>
  <div class="bilibili_home_page">
    <!-- 导航栏 -->
    <head-line class="HeadLine" :top_navigation_bar_li_color="'#ffffff'"></head-line>
    <!-- 分类 -->
...
store.top_navigation_bar_li_color = "#ffffff";
store.top_navigation_bar_login_background_color = "#ffffff";
</script>
