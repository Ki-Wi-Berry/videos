  ...
  <nav class="top_navigation">
    <ul class="top_navigation_bar">
      ...
      <li
        ...
        @animationend="show_login_box_drop"
        ...
        <div class="top_navigation_bar_login_box">
          <router-link
            ...
            :class="{
              ...
              show_login_box_drop: data.login_box_animation,
              hide_login_box_drop: !data.login_box_animation,
            }"
            :style="
              store.islogin
                ? {
          ...
          <div class="top_navigation_bar_login_drop" v-if="data.login_box_drop">
...
// 开始动画效果
const show_login_box_animation = function () {
  if (store.islogin) {
...
// 显示登录下拉菜单
const show_login_box_drop = function () {
  if (store.islogin&&data.login_box_animation) {
...
const hide_login_box_drop = async function () {
  if (store.islogin&&data.login_box_drop&&data.login_box_animation) {
    await setTimeout(() => {
...
.top_navigation {
  ...
  .top_navigation_bar {
    ...
    .top_navigation_bar_li {
      ...
      .hide_login_box_drop {
        animation: leftUpMove 0.2s forwards;
        .top_navigation_bar_login_drop{
          animation: hide_login_drop 0.2s forwards;
        }
      }
