        ...
        <div class="top_navigation_bar_login_box">
          ...
          <div class="top_navigation_bar_login_drop">
            ...
            <div class="top_navigation_bar_login_coin">
              <span class="color1">硬币:</span><span class="color2">&nbsp;207&nbsp;&nbsp;</span>
              <span class="color1">B币:</span><span class="color2">&nbsp;0</span>
            </div>
            <div class="top_navigation_bar_login_status_box">
              <div class="top_navigation_bar_login_status" v-for="item in data.top_navigation_bar_login_status" :key="item">
                <span class="top_navigation_bar_login_nums">{{item.nums}}</span>
                <span class="top_navigation_bar_login_text">{{item.text}}</span>
              </div>
              
            </div>
            <div class="top_navigation_bar_login_user_space"></div>
          </div>
        </div>
      </li>
      <li
      ...
      .top_navigation_bar_login_box {
        ...
        .top_navigation_bar_login_drop{
          ...
          .top_navigation_bar_login_status_box{
            border-top: #a7a9ab 0.1rem solid;
            margin-top: -11.5rem;
            padding-top:1.5rem ;
            height: 4rem;
            width: 100%;
