  ...
  <nav class="top_navigation">
    <ul class="top_navigation_bar">
      ...
      <li class="top_navigation_bar_li">
        <div class="search_record_box" id="search_record_box_id" @click="show_browsing_history1">
          <!-- 搜索框 -->
      ...
      <li class="top_navigation_bar_li top_navigation_bar_li_login">
        <div
...
.top_navigation {
  ...
  .top_navigation_bar {
    ...
    .top_navigation_bar_li {
      ...
      .top_navigation_bar_login:hover {
        animation: rightDownMove 1s both;
