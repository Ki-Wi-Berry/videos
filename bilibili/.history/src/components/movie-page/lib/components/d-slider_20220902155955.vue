...
const mousemoveHandle = (ev: MouseEvent) => {
    ...
    // 提示宽的一半宽度
    let refTipsWidth = (refTips.value as HTMLButtonElement).clientWidth;
...
.d-slider {
  ...
  .d-slider__runway {
    ...
    .d-slider__cursor, .d-slider__preload, .d-slider__bar {
      position: absolute;
      top: 0;
      left: 0;
      height: 100%;
  ...
  &.is-vertical {
    ...
    .d-slider__runway {
      ...
      width: v-bind(size);
      margin: 0 6px;
      .d-slider__preload, .d-slider__bar, .d-slider__cursor {
        bottom: 0;
        top: auto;
        width: 100%;
      }
