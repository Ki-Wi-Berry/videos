...
<template>
  ...
  <img class="img" :src="state.Thumbnails" alt="123">
</template>
<script lang="ts">
export default {
  name: "vue3VideoPlay",
...
// console.log( document.getElementById("Vvideo").duration);
  ...
  // }, 1000);
  // state.Vvideo.removeEventListener
}

// 预处理预览图
const preloadVideoThumbs = () => {

state.Vvideo.addEventListener('canplay', async function () {
