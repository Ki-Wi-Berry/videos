...
const preloadVideoThumbs = () => {
  ...
  const event = async function () {
    ...
    let video:HTMLElement|null  = document.getElementById('Vvideo');
    let video_f :HTMLElement|null = document.getElementById('Vvideo_f');
