...
<template>
    ...
    <div class="d-player-control" ref="refPlayerControl" v-if="!isMobile && state.control">
      <div class="d-control-progress">
        <d-slider class="d-progress-bar" @onMousemove="onProgressMove" @change="progressBarChange"
          ...
          :preload="state.preloadBar" :Thumbnails="state.Thumbnails" :nowImgIndex="state.nowImgIndex"></d-slider>
      </div>
  ...
  <img class="img" :src="state.Thumbnails[6]" alt="123">
</template>
<script lang="ts">
export default {
  name: "vue3VideoPlay",
