<template>
  ...
  <div class="pop_up">
    ...
    <div class="send_wrap">
      ...
      <div class="send_btn">
        <span class="send_btn_span">发送</span>
      </div>
...
(function () {
  ...
  let barrageBoxWrap = document.querySelector('.video_play') as Element;
  let barrageBox = document.querySelector('.barrage-container')as Element;
  let inputBox = document.querySelector('.input')as Element;
  let sendBtn = document.querySelector('.send-btn')as Element;

  //容器的宽高度
  let barrageWidth = ~~window.getComputedStyle(barrageBoxWrap as Element).width.replace('px', '') ;
  let barrageHeight = ~~window.getComputedStyle(barrageBoxWrap as Element).height.replace('px', '');
