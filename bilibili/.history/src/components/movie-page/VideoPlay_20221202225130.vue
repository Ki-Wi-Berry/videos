<template>
  ...
  <div class="pop_up">
    ...
    <div class="send_wrap">
      <input type="text" class="input" placeholder="发个友善的弹幕见证当下">
      <div class="send_btn">
...
(function () {
  ...
  var barrageBoxWrap = document.querySelector('.video_play');;
  var barrageBox = document.querySelector('.barrage-container');
  var inputBox = document.querySelector('.input');
  var sendBtn = document.querySelector('.send-btn');

  //容器的宽高度
  var barrageWidth = ~~window.getComputedStyle(barrageBoxWrap as Element).width.replace('px', '') ;
  var barrageHeight = ~~window.getComputedStyle(barrageBoxWrap as Element).height.replace('px', '');
